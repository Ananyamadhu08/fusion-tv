...
export const createPlaylist = async (
  ...
  try {
    ...
    if (status >= 200 && status < 300) {
      ...
      showToast("Create playlist success!", "success");
    }
  } catch (error) {
    playlistDispatch({
      type: playlistActions.ERROR,
...
export const addToPlaylist = async (
  ...
  try {
    ...
    if (status >= 200 && status < 300) {
      ...
      showToast("Add video to playlist success!", "success");
    }
  } catch (error) {
    playlistDispatch({
      type: playlistActions.ERROR,
...
export const removeVideoFromPlaylist = async (
  ...
  try {
    ...
    if (status >= 200 && status < 300) {
      ...
      showToast("Remove video from playlist success!", "success");
    }
  } catch (error) {
    playlistDispatch({
      type: playlistActions.ERROR,
...
export const deletePlaylist = async (
  ...
  try {
    ...
    if (status >= 200 && status < 300) {
      ...
      showToast("Delete playlist success!", "success");
    }
  } catch (error) {
    playlistDispatch({
      type: playlistActions.ERROR,
